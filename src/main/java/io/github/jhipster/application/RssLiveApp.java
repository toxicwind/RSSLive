...
public class RssLiveApp {

    private static final Logger log = LoggerFactory.getLogger(RssLiveApp.class);

    private final Environment env;

    public RssLiveApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RssLiveApp.class);
